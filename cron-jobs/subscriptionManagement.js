    ...
    try {
        ...
        for (const subscription of upcomingRenewals) {
            try {
                ...
                logger.info(`Created renewal order ${renewalOrder._id} for subscription ${subscription._id}`);
...
const sendRenewalReminders = async () => {
    try {
        ...
        for (const subscription of subscriptionsNeedingReminders) {
            ...
            logger.info(`Sending renewal reminder to ${subscription.user.email} for subscription ${subscription._id}`);
