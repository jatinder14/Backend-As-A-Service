export const Careers = [
  ...
  "Cultura lavorativa dinamica",
  "Prospera in un ambiente dinamico e collaborativo in cui le tue idee e i tuoi contributi sono apprezzati.",
  "Opportunità di crescita",
  "Investiamo nel tuo sviluppo professionale attraverso programmi di formazione, tutoraggio e opportunità di avanzamento di carriera.",
  "Progetti diversi",
  "Lavora su immobili di prestigio nei quartieri più ambiti di Dubai, entrando in contatto con una rete globale di clienti e investitori.",
  "Approccio guidato dall&#39;innovazione",
  "Entra a far parte di un&#39;azienda che abbraccia tecnologie all&#39;avanguardia e soluzioni creative per ridefinire il settore immobiliare.",
  "Riconoscimento e premi",
  "Festeggia il tuo successo con un pacchetto di benefit competitivo, incentivi e programmi di riconoscimento.",
];
