...
const UserSchema = new mongoose.Schema({
    ...
    role: {
        type: String,
        enum: {
            values: ['admin', 'ceo', 'sales', 'onboarding', 'operations_manager', 'hr', 'accounts', 'inventory', 'property_management', 'customer'],
            message: 'Invalid role. Must be one of: admin, ceo, sales, onboarding, operations_manager, hr, accounts, inventory, property_management, customer'
        },
        default: 'customer'
    },
    position: {
    ...
    subscriptionStatus: {
        ...
        enum: {
            ...
            message: 'Invalid subscription status. Must be one of: active, inactive, expired, cancelled'
        },
        default: 'inactive'
    },
