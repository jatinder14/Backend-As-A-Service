...
export const translateBlogDetail = async (dynamicText: any, globalState: any) => {
  ...
  try {
    ...
    const convertedArray: any = await convertResponseArrayObject(response.data.data.translations);
